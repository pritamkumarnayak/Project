...
public class EmployeeController {
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable Long id, @RequestBody Employee employeeDetails){
		...
		employee.setRegistrationId(employeeDetails.getRegistrationId());
		...
		employee.setAssignedJobRole(employeeDetails.getAssignedJobRole());
		employee.setExperiencedAboutVehicle(employeeDetails.getExperiencedAboutVehicle());
